...
AS $$
DECLARE
  project_url TEXT := 'https://kwmnzrblgfzzmlrepnkz.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imt3bW56cmJsZ2Z6em1scmVwbmt6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNzQ2ODAxOSwiZXhwIjoyMDMzMDQ0MDE5fQ.fAbD_Epz8vdF9luA3ahbPKUiI2KhpVuX8ZZp1ykZ3gY'; -- full access needed for http request to storage
